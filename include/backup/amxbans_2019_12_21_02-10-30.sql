...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 21 2019 г., 02:07
...
(1, 1576881346, '127.0.0.1', 'admin', 'Install', 'Installation AMXBans v6.14.4');
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1, NULL, 'admin@amxbans.local', 1576883164, 0);
...
(1, 'amxbans', 50, 'default', 'amxbans.png', 'http://www.amxbans.net', 'english', 'view.php', 1, 1, 1, 0, 0, 1, 2, 'dem,zip,rar,jpg,gif,png', 0, 10, 'max offences reached', 1, 1);
