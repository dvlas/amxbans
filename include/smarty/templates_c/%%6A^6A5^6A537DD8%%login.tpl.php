<?php /* Smarty version 2.6.25, created on 2019-12-21 01:51:27
...
<table width="50%" border="1" cellpadding="2">
	...
	<tr class="table_list">
		<td>
			...
			<table width='20%'>
				<tr><td class="enter"><?php echo ((is_array($_tmp='_USERNAME')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
:</td> <td class='enter'><input type="text" name="user" /></td><td><input type='checkbox' checked="checked" name='remember'></input> <?php echo ((is_array($_tmp='_REMEMBERME')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td></tr>
				<tr><td class="enter"><?php echo ((is_array($_tmp='_PASSWORD')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
:</td> <td class='enter'><input type="password" name="pass" /></td><td><button type="submit" name="action" id="action2" value="Login"><?php echo ((is_array($_tmp='_LOGIN')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</button></td></tr>
