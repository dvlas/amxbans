...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'user_bd.tpl', 11, false),array('modifier', 'date_format', 'user_bd.tpl', 135, false),array('modifier', 'date2word', 'user_bd.tpl', 155, false),array('modifier', 'file_size', 'user_bd.tpl', 347, false),array('modifier', 'bbcode2html', 'user_bd.tpl', 349, false),)), $this); ?>
<div class="main">
		...
		<table frame="box" rules="groups" summary=""> 
			...
			<thead> 
				...
				<tr>
					...
					<th class="_right">
						<?php if ($this->_tpl_vars['ban_detail']['bid'] != '62175'): ?>
...
_gfx/page_edit.png" border="0" onclick="NewToggleLayer('banedit_<?php echo $this->_tpl_vars['ban_detail']['bid']; ?>
...
" style="cursor:pointer;border:0;" />
						...
						<?php if ($this->_supers['session']['bans_delete'] == 'yes' || ( $this->_supers['session']['bans_delete'] == 'own' && $this->_supers['session']['uname'] == $this->_tpl_vars['ban_detail']['username'] )): ?>
							...
							<input name="del_ban" type="image" src="templates/<?php echo $this->_tpl_vars['design']; ?>
...
" />
			...
			<tbody> 
...
</td><td><?php echo $this->_tpl_vars['ban_detail']['player_id']; ?>
</td>
				...
				<tr>
					...
					<?php if ($this->_tpl_vars['ban_detail']['player_id'] <> ""): ?>
...
</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_detail']['ban_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td>
				...
				<tr>
					...
					<td>
						...
						<?php else: ?>
							...
							<?php echo ((is_array($_tmp=$this->_tpl_vars['ban_detail']['ban_end'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
...
<?php endif; ?></td>
				...
				<tr>
					...
					<td class="fat"><?php echo ((is_array($_tmp='_TRACKBACK')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td><td><a href="http://<?php echo $this->_supers['server']['HTTP_HOST']; ?>
<?php echo $this->_supers['server']['PHP_SELF']; ?>
?bid=<?php echo $this->_tpl_vars['ban_detail']['bid']; ?>
">http://<?php echo $this->_supers['server']['HTTP_HOST']; ?>
<?php echo $this->_supers['server']['PHP_SELF']; ?>
?bid=<?php echo $this->_tpl_vars['ban_detail']['bid']; ?>
</a></td>
...
" />
						...
						<tr>
							...
							<td><?php echo ((is_array($_tmp=$this->_tpl_vars['demos']['upload_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td> 
...
" />
										...
										<?php if ($this->_supers['session']['bans_edit'] == 'yes' || ( $this->_supers['session']['bans_edit'] == 'own' && $this->_supers['session']['uname'] == $this->_tpl_vars['demos']['name'] )): ?>
...
" style="cursor:pointer;"/>
										...
										<?php if ($this->_supers['session']['bans_delete'] == 'yes' || ( $this->_supers['session']['bans_delete'] == 'own' && $this->_supers['session']['uname'] == $this->_tpl_vars['demos']['name'] )): ?>

											<input name="del_demo" type="image" src="templates/<?php echo $this->_tpl_vars['design']; ?>
_gfx/page_delete.png" border="0" onclick="return confirm('<?php echo ((is_array($_tmp='_DELDEMO')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
<?php echo ((is_array($_tmp='_DATALOSS')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
					...
					<table frame="box" rules="groups" summary=""> 
						...
						<tbody> 
							...
							<tr> 
								...
								<td style="width:130px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['comments']['date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td> 
...
<?php else: ?><span style='font-style:italic;font-weight:bold'><?php echo ((is_array($_tmp='_HIDDEN')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
								...
								<td class="_right" style="width:80px;">
									...
									<?php if ($this->_supers['session']['bans_edit'] == 'yes'): ?>
										...
										<img src="images/page_edit.png" title="<?php echo ((is_array($_tmp='_EDIT')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
" border="0" style="cursor:pointer;" onClick="NewToggleLayer('comedit_<?php echo $this->_tpl_vars['comments']['id']; ?>
');" />

										<input name="del_comment" type="image" src="templates/<?php echo $this->_tpl_vars['design']; ?>
_gfx/page_delete.png" border="0" onclick="return confirm('<?php echo ((is_array($_tmp='_DELCOMMENT')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
<?php echo ((is_array($_tmp='_DATALOSS')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
