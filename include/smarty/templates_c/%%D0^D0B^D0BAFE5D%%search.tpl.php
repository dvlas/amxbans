<?php /* Smarty version 2.6.25, created on 2019-12-25 00:14:35
         compiled from search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'search.tpl', 6, false),array('modifier', 'date_format', 'search.tpl', 44, false),array('modifier', 'date2word', 'search.tpl', 143, false),array('function', 'html_options', 'search.tpl', 104, false),)), $this); ?>
<div class="main">
	<div class="post">
...
_gfx/calendar.png" width="16" height="16" border="0" alt="<?php echo ((is_array($_tmp='_PICK_DATE')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
...
');">
					...
					<td><?php echo $this->_tpl_vars['ban_list_aktiv']['player_id']; ?>
</td>
...
" />
							<table width="90%" class="table_details" cellspacing="0">
								<tr>
									<td class="table_details_head" width="20%"><b><?php echo ((is_array($_tmp='_BANDETAILS')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</b></td>
...
:</b></td><td><?php if ($this->_tpl_vars['ban_list_aktiv']['player_id'] <> ""): ?><?php echo $this->_tpl_vars['ban_list_aktiv']['player_id']; ?>
...
:</b></td><td>
									<?php if ($this->_tpl_vars['ban_list_aktiv']['player_id'] <> ""): ?>
										<a href="http://steamcommunity.com/profiles/<?php echo $this->_tpl_vars['ban_list_aktiv']['player_comid']; ?>
...
:</b></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_list_aktiv']['ban_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td></tr>
...
</i><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_list_aktiv']['ban_end'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
...
');">
					...
					<td><?php echo $this->_tpl_vars['ban_list_exp']['player_id']; ?>
</td>
...
:</b></td><td><?php echo $this->_tpl_vars['ban_list_exp']['player_nick']; ?>
								...
								<tr><td><b><?php echo ((is_array($_tmp='_STEAMID')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
:</b></td><td><?php if ($this->_tpl_vars['ban_list_exp']['player_id'] <> ""): ?><?php echo $this->_tpl_vars['ban_list_exp']['player_id']; ?>
<?php else: ?><?php echo ((is_array($_tmp='_NOSTEAMID')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
<?php endif; ?></td></tr>
								<tr><td><b><?php echo ((is_array($_tmp='_STEAMCOMID')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
:</b></td><td>
									<?php if ($this->_tpl_vars['ban_list_exp']['player_id'] <> ""): ?>
										<a href="http://steamcommunity.com/profiles/<?php echo $this->_tpl_vars['ban_list_exp']['player_comid']; ?>
...
:</b></td><td><?php echo $this->_tpl_vars['ban_list_exp']['ban_reason']; ?>
								...
								<tr><td><b><?php echo ((is_array($_tmp='_INVOKED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
:</b></td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_list_exp']['ban_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td></tr>
								<tr><td><b><?php echo ((is_array($_tmp='_BANLENGHT')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
...
</i><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['ban_list_exp']['ban_end'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
