...
<br />
								<img src="include/captcha.php" alt="<?php echo ((is_array($_tmp='_SCODE')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
" style="border: 1px #000000 solid;"><br />
